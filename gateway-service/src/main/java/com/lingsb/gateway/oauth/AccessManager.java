//package com.lingsb.gateway.oauth;
//
...
//
//    //有一些访问路径是不需要进行token校验的
//
//    public AccessManager() {
//        //对于我们获取token的 /oauth/token,人家正在获取token的路上，本身就没有token
//        //必须放行
//        permitAll.add("/**/oauth/**");
//    }
//
...
//        return permitAll.stream().filter(p -> antPathMatcher.match(p, requestPath)).findFirst().isPresent();
//    }
//
//}
